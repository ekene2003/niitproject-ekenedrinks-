...
<html lang="en">
     ...
     <body class="form-body">
          ...
          <div class="form-section" id="order">
               <div class="container">
                              <form action="order.php" method="post" class="signup-form row">
                                   ...
                                   <div class="mb-3 col-md-6">
                                        <label for="c-pass" class="form-label">Confirm
                                             Password</label>
                                        <input type="email" class="form-control" id="c-pass"
                                   ...
                                   <button type="submit" class="order-submitBtn">Sign Up</button>
                              <div class="signup-small mt-3 text-center">Have an account? Login</div>
                              </form>
                              <form action="order.php" method="post" class="login-form mt-5">
                                   <div class="form-section-title">
